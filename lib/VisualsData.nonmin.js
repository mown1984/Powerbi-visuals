!function(modules) {
    ...
    346: function(module, exports, __webpack_require__) {
        ...
        window.debug = window.debug || {}, window.InJs = window.InJs || {}, __webpack_require__(347), 
    ...
    420: function(module, exports) {
        ...
        !function(powerbi) {
            ...
            !function(data) {
                ...
                data.SQFrom = SQFrom, data.isSQFromEntitySource = isSQFromEntitySource, data.isSQFromSubquerySource = isSQFromSubquerySource;
        ...
        !function(powerbi) {
            ...
            !function(data) {
                var ArrayExtensions = jsCommon.ArrayExtensions, SemanticQuery = function() {
                    ...
                    }, SemanticQuery.prototype.equals = function(query) {
                        return this === query;
                    }, SemanticQuery;
                }();
