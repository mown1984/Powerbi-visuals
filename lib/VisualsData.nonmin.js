    ...
    !function(data) {
        ...
        !function(DataViewPivotCategoricalToPrimaryGroups) {
            ...
            function inferUnpivotTransform(selects, dataViewMappings, dataView) {
                ...
                var roleKinds = data.DataViewSelectTransform.createRoleKindFromMetadata(selects, dataView.metadata), projections = data.DataViewSelectTransform.projectionsFromSelects(selects);
    ...
    !function(data) {
        ...
        !function(DataViewTransform) {
            ...
            function transformDataView(prototype, objectDescriptors, roleMappings, transforms, colorAllocatorFactory, dataRoles, selectsToInclude) {
                ...
                transformed = data.DataViewConcatenateCategoricalColumns.detectAndApply(transformed, roleMappings, transforms.projectionOrdering), 
        ...
        !function(DataViewRegression) {
            function run(options) {
                ...
                if (1 === transformedDataViews.length && transformSelects && dataView.metadata) {
                    var roleKindByQueryRef = data.DataViewSelectTransform.createRoleKindFromMetadata(transformSelects, dataView.metadata), projections = data.DataViewSelectTransform.projectionsFromSelects(transformSelects);
    ...
    !function(DataViewAnalysis) {
        ...
        function chooseDataViewMappings(projections, mappings, roleKindByQueryRef, objectDescriptors, objectDefinitions) {
            for (var supportedMappings = [], errors = [], mappingIndex = 0, mappingCount = mappings.length; mappingCount > mappingIndex; mappingIndex++) {
                var mapping = mappings[mappingIndex], mappingConditions = mapping.conditions, requiredProperties = mapping.requiredProperties, conditionsMet = !1, allPropertiesValid = areAllPropertiesValid(requiredProperties, objectDescriptors, objectDefinitions);
                if (_.isEmpty(mappingConditions)) conditionsMet = !0; else for (var conditionIndex = 0, conditionCount = mappingConditions.length; conditionCount > conditionIndex; conditionIndex++) {
                    ...
                    if (_.isEmpty(currentConditionErrors)) conditionsMet = !0; else for (var _i = 0; _i < currentConditionErrors.length; _i++) {
...
!function(powerbi) {
    ...
    !function(data) {
        ...
        !function(SQExprUtils) {
            ...
            SQExprUtils.getKpiMetadata = getKpiMetadata, SQExprUtils.getDefaultValue = getDefaultValue, 
...
!function(powerbi) {
    ...
    !function(data) {
        ...
        !function(DataViewConcatenateCategoricalColumns) {
            function detectAndApply(dataView, roleMappings, projectionOrdering) {
