    ...
    !function(data) {
        ...
        var DataViewCategoricalReader = function() {
            function DataViewCategoricalReader(dataView) {
                ...
                var hasAnyValidValues = this.hasAnyValidValues = null != values;
    ...
    !function(data) {
        ...
        !function(DataViewConcatenateCategoricalColumns) {
            ...
            function applyConcatenation(dataView, roleName, columnsSortedByProjectionOrdering, queryRefsToIgnore) {
                var concatenatedValues = concatenateValues(columnsSortedByProjectionOrdering, queryRefsToIgnore), concatenatedColumnMetadata = createConcatenatedColumnMetadata(roleName, columnsSortedByProjectionOrdering, queryRefsToIgnore), transformedDataView = inheritSingle(dataView);
            ...
            function concatenateValues(columnsSortedByProjectionOrdering, queryRefsToIgnore) {
                for (var concatenatedValues = [], _i = 0, columnsSortedByProjectionOrdering_1 = columnsSortedByProjectionOrdering; _i < columnsSortedByProjectionOrdering_1.length; _i++) for (var categoryColumn = columnsSortedByProjectionOrdering_1[_i], i = 0, len = categoryColumn.values.length; len > i; i++) if (!_.contains(queryRefsToIgnore, categoryColumn.source.queryName)) {
            ...
            function createConcatenatedColumnMetadata(roleName, columnsSortedByProjectionOrdering, queryRefsToIgnore) {
                for (var concatenatedDisplayName, columnForCurrentDrillLevel = _.last(columnsSortedByProjectionOrdering), consistentIsMeasure = columnForCurrentDrillLevel.source.isMeasure, _i = 0, columnsSortedByProjectionOrdering_2 = columnsSortedByProjectionOrdering; _i < columnsSortedByProjectionOrdering_2.length; _i++) {
                    var categoryColumn = columnsSortedByProjectionOrdering_2[_i], columnSource = categoryColumn.source;
                    _.contains(queryRefsToIgnore, categoryColumn.source.queryName) || (concatenatedDisplayName = null == concatenatedDisplayName ? columnSource.displayName : columnSource.displayName + " " + concatenatedDisplayName, 
        ...
        !function(DataViewRegression) {
            function run(options) {
                ...
                if (1 === transformedDataViews.length && transformSelects && dataView.metadata) {
                    ...
                    if (!roleKindByQueryRef || !projections || _.isEmpty(dataViewMappings) || !objectDescriptors || !objectDefinitions) return transformedDataViews;
            ...
            function getColumnForCategoricalRole(roleName, categorical) {
                ...
                if (categorical.values && categorical.values.source) return null;
            ...
            function getRoleFromColumn(roleName, columns) {
                return _.isEmpty(columns) ? void 0 : _.find(columns, function(column) {
                    return column.source.roles[roleName];
                });
            }
...
!function(powerbi) {
    ...
    !function(data) {
        var utils;
        !function(utils) {
            var DataViewMatrixUtils, inherit = powerbi.Prototype.inherit, inheritSingle = powerbi.Prototype.inheritSingle;
            !function(DataViewMatrixUtils) {
                ...
                function forEachLeafNodeRecursive(matrixNode, nextIndex, callback) {
                    if (_.isEmpty(matrixNode.children)) callback(matrixNode, nextIndex), nextIndex++; else for (var children = matrixNode.children, i = 0, len = children.length; len > i; i++) {
                        ...
                        nextChild && (nextIndex = forEachLeafNodeRecursive(nextChild, nextIndex, callback));
                    }
                    return nextIndex;
                }
        ...
        var ScriptInputColumnNameVisitor = function(_super) {
            ...
            return __extends(ScriptInputColumnNameVisitor, _super), ScriptInputColumnNameVisitor.prototype.visitEntity = function(expr) {
                ...
                if (field.columnHierarchyLevelVariation) {
                    ...
                    if (!prop) return;
                    for (var variations = prop.column.variations, _i = 0, variations_1 = variations; _i < variations_1.length; _i++) {
    ...
    !function(data) {
        ...
        function dateTimeSupported(targetTypes) {
            ...
            for (var _i = 0, targetTypes_1 = targetTypes; _i < targetTypes_1.length; _i++) {
                ...
                if (targetType.dateTime) return !0;
            }
        }
        ...
        var SQAggregationOperations = function() {
            ...
            return SQAggregationOperations.prototype.getSupportedAggregates = function(expr, schema, targetTypes) {
                ...
                var aggregates = [];
                this.datetimeMinMaxSupported && valueType.dateTime && dateTimeSupported(targetTypes) && (aggregates.push(Agg.Min), 
