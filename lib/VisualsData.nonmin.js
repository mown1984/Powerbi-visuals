                    ...
                    if (measureCount > 0) {
                        var index = 0, callback = function(node) {
                            if (node.values) {
                                ...
                                for (var i = 0; measureCount > i; i++) pivotedRowNode.values[index++] = node.values[i];
                                delete node.values;
                            }
                            if (measureCount > 1) {
    ...
    !function(data) {
        ...
        !function(DataViewPivotCategoricalToPrimaryGroups) {
            ...
            function unpivotMatrix(oldMatrix) {
                ...
                if (oldChildren) for (var addCategory = function(identity, value) {
                    var key = identity.key, index = categoryIndex[key];
                    void 0 === index && (index = categories.length, categoryIndex[key] = index, categories.push({
                        value: value,
                        identity: identity
                    }));
        ...
        !function(DataViewTransform) {
            ...
            function reorderMatrixCompositeGroups(prototype, supportedDataViewMapping, projection) {
                ...
                if (prototype && supportedDataViewMapping && projection) {
                    ...
                    }), (transformedRowsHierarchy || transformedColumnsHierarchy) && (transformedDataView = inheritSingle(prototype), 
...
!function(powerbi) {
    ...
    !function(data) {
        ...
        !function(SQExprBuilder) {
            ...
            SQExprBuilder.createExprWithAggregate = createExprWithAggregate, SQExprBuilder.fillRule = fillRule, 
...
!function(powerbi) {
    ...
    !function(data) {
        ...
        !function(SQExprUtils) {
            ...
            SQExprUtils.getSupportedAggregates = getSupportedAggregates, SQExprUtils.supportsArithmetic = supportsArithmetic, 
            SQExprUtils.isSupportedAggregate = isSupportedAggregate, SQExprUtils.indexOfExpr = indexOfExpr, 
