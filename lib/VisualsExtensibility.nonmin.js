!function(modules) {
    ...
    421: function(module, exports, __webpack_require__) {
        ...
        window.debug = window.debug || {}, window.InJs = window.InJs || {}, __webpack_require__(422), 
        __webpack_require__(423), __webpack_require__(424), __webpack_require__(425), __webpack_require__(426), 
        __webpack_require__(427), __webpack_require__(428), __webpack_require__(429), __webpack_require__(430), 
            ...
            !function(extensibility) {
                ...
                var VisualAdapter = function() {
                    function VisualAdapter(visualPlugin, telemetryService) {
                        ...
                        this.telemetryService && this.plugin.custom && this.telemetryService.logEvent(ExtensibilityVisualApiUsage, this.plugin.name, this.plugin.apiVersion, !!this.plugin.custom, void 0, isError, powerbi.visuals.telemetry.ErrorSource.User);
                    }
            ...
            !function(extensibility) {
                var VisualException = powerbi.visuals.telemetry.VisualException, VisualSafeExecutionWrapper = function() {
                    function VisualSafeExecutionWrapper(wrappedVisual, visualInfo, telemetryService, silent) {
                        ...
                        this.silent = silent, this.telemetryService && (this.perfLoadEvent = this.telemetryService.startEvent(powerbi.visuals.telemetry.ExtensibilityVisualApiUsage, visualInfo.apiVersion, visualInfo.name, visualInfo.custom));
                    }
