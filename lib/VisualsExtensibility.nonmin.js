    ...
    !function(extensibility) {
        var SelectionManager = function() {
            ...
            return SelectionManager.prototype.select = function(selectionId, multiSelect) {
                ...
                var defered = this.promiseFactory.defer();
                return this.selectedIds = [], this.sendSelectionToHost([]), defered.resolve(null), 
                defered.promise;
    ...
    !function(extensibility) {
        ...
        var VisualAdapter = function() {
            ...
            return VisualAdapter.prototype.init = function(options) {
                ...
                options.type & powerbi.VisualUpdateType.Resize && this.visualHasMethod("onResizing") ? this.onResizing(options.viewport) : this.visualHasMethod("update") ? this.visualLegacy.update(options) : ((!options.type || options.type & powerbi.VisualUpdateType.Data) && this.onDataChanged(_.pick(options, [ "dataViews", "operationKind" ])), 
                ...
                this.visualHasMethod("onResizing") && this.visualLegacy.onResizing(finalViewport);
        ...
        var VisualException = powerbi.visuals.telemetry.VisualException, VisualSafeExecutionWrapper = function() {
            ...
            return VisualSafeExecutionWrapper.prototype.init = function(options) {
                ...
                this.wrappedVisual.onResizing && this.executeSafely(function() {
                    return _this.wrappedVisual.onResizing(finalViewport);
                });
