...
!function(jsCommon) {
    ...
    var Utility = function() {
        ...
        }, Utility.isValidImageUrl = function(url) {
            if (_.isEmpty(url)) return !1;
            var match = jsCommon.RegExpExtensions.run(Utility.imageUrlRegex, url);
            return !!match && 0 === match.index;
        ...
        Utility.urlRegex = /http[s]?:\/\/(\S)+/gi, Utility.imageUrlRegex = /http[s]?:\/\/(\S)+(png|jpg|jpeg|gif|svg)/gi, 
        Utility;
    }();
